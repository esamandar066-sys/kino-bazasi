...
export const api = {
  ...
  phoneAuth: {
    sendCode: {
      ...
      input: z.object({ phoneNumber: z.string().min(9), telegramUsername: z.string().optional() }),
      responses: {
        200: z.object({ message: z.string(), codeSentDirectly: z.boolean(), method: z.string(), telegramBotUrl: z.string().optional() }),
        400: errorSchemas.validation,
      },
    },
    verifyCode: {
